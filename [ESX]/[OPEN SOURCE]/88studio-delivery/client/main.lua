...
GetFreeParkingSpots = function()
    for _, parkingSpot in ipairs(ParkingSpot) do
        local veh, distance = Framework.Game.GetClosestVehicle({x = parkingSpot.x, y = parkingSpot.y, z = parkingSpot.z})
...
RegisterNetEvent('88studio-delivery:client:openTablet', function()
    ...
    Framework.TriggerServerCallback('88studio-delivery:server:userDetail', function(data)
